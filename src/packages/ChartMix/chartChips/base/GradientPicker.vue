  ...
  >
    <el-tooltip :disabled="!tooltip" :open-delay="500" :content="tooltip" effect="dark" placement="bottom">
      ...
      >
        ...
        >
          <i class="luckyIconfont icon-jiantou"></i>
        </div>
        <div
              ...
              <el-button-group style="margin-top: 2px;">
                <el-tooltip class="item" content="添加触点" effect="dark" placement="top">
                  <el-button
                    ...
                    type="danger"
                  >
                    <i class="luckyIconfont icon-jia" style="font-size:12px;"></i>
                  </el-button>
                </el-tooltip>
                ...
                <el-tooltip class="item" content="删除触点" effect="dark" placement="top">
                  <el-button
                    ...
                    type="danger"
                  >
                    <i class="luckyIconfont icon-jianshao" style="font-size:12px;"></i>
                  </el-button>
                </el-tooltip>
              </el-button-group>
            </el-col>
                ...
                >
                  ...
                  >
                    <i
                      ...
                      class="luckyIconfont icon-zhcc_xiangshangjiantou"
