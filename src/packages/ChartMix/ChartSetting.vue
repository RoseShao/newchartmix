              ...
              <el-col :span="22">
                ...
                <div style="margin-top: 10px;">
                  <el-button @click="showList = !showList" size="small" style="width:100%;">
                    <i :class="chartTypeTxt[0]" class="luckyIconfont" style="float:left;"></i>
                    {{chartTypeTxt[1]}}
                    <i
                      class="luckyIconfont icon-jiantou"
                      style="float:right;"
                    ></i>
                  </el-button>
                </div>
                    ...
                    <el-row :gutter="10">
                      ...
                      <el-col :span="20">
                        <el-tag size="medium" style="width:100%;text-align:center;">
                          <i :class="item.type" class="luckyIconfont" style="float:left;"></i>
                          {{ item.field }}
                        </el-tag>
                      </el-col>
                    </el-row>
                        ...
                        >
                          ...
                          <el-dropdown-menu slot="dropdown" style="min-width:306px;">
                            ...
                            >
                              {{ditem.field}}
                              <i
                                class="luckyIconfont icon-dagou"
                                style="float:right;"
