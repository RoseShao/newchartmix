...
const setChartOptionsByRouter = function (chartOptions, router, updateObj) {
    ...
    renderChart({chartOptions: chartOptions,updateObj:updateObj})
    return chartOptions;
}
const insertFunc = function (func){
    store.myNewFunc = func;
}
/**
...
const renderChart = function (renderChartObj, ele) {
    ...
    if(store.myNewFunc !==undefined && typeof store.myNewFunc == 'function')store.myNewFunc(renderChartObj.chartOptions,renderChartObj.updateObj);
}
